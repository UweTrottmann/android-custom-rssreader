...
public class PreferenceActivity extends ListActivity {
	...
	private OnClickListener saveButtonListener= new OnClickListener(){
		...
		public void onClick(View v) {
			...
			updateQueryEnabled = "update " + mDbHelper.getPreferenceTable() + " set enabled = 1 where pref_category_id in " + enabledIds + "" ;
			updateQueryDisabled = "update " + mDbHelper.getPreferenceTable() + " set enabled = 0 where pref_category_id in " + disabledIds + "";
